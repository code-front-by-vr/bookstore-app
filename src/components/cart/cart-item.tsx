...
export default function CartItem({book, quantity}: {book: BookType; quantity: number}) {
  ...
  return (
    <Link href={`/books/all/${book.isbn13}`} className="block">
      <div className="flex items-center gap-4 py-4 px-4 bg-white shadow-sm shadow-black/5 hover:shadow-md hover:shadow-black/10 transition-all duration-200 cursor-pointer">
